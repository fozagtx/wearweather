            ...
            {photos.map((photo) => {
              ...
              return (
                <figure key={photo.id} className="relative">
                  ...
                  >
                    <img src={photo.url} alt="" className="block h-auto w-full" draggable={false} />
                    {active && (
          ...
          <div>
            {examplePhotoUrl && (
              <div className="relative">
                <img src={examplePhotoUrl} alt="Example try-on photo" className="block h-auto w-full rounded-lg" />
                <span className="absolute top-2 left-2 rounded-md bg-background/90 px-1.5 py-0.5 font-mono text-[9px] tracking-[0.12em]">
                  EXAMPLE IN USE
                </span>
              </div>
